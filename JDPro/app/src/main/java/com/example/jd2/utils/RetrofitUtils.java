...
import com.example.jd2.app.MyApplication;
import com.example.jd2.utils.api.NetApi;
...
public class RetrofitUtils implements INetWork {
    ...
    /**
     * 两种形式--服务器支持缓存，设置标志就好了,如果不支持，就修改请求头，让服务器支持缓存
     * 什么情况下使用缓存？ == 没网的时候，网络请求进行缓存
     */
    ...
    private boolean isNetWorkVaild() {
